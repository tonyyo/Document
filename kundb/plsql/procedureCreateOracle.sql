...
CREATE PROCEDURE oracle_pay(`v_w_id` int(11), `v_c_w_id` int(11), `v_h_amount` decimal(12,2), `v_d_id` int(11), `v_c_d_id` int(11), `v_c_id` int(11), `v_c_last` varchar(16), `v_c_by_name` int(11))
IS
DECLARE
